...
{/*<Link to="/about" className="w-full block py-4 text-center hover:text-gray-900">
    <svg className="w-6 h-6 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <Link to="blog" className="w-full block py-4 text-center hover:text-gray-900">
    <svg className="w-6 h-6 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <Link to="/projects" className="w-full block py-4 text-center hover:text-gray-900">
    <svg className="w-6 h-6 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
